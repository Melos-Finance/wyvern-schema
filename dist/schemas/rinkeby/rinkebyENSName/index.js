...
exports.rinkebyENSNameSchema = void 0;
const Web3 = require("web3");
const ens_1 = require("../../../common/ens");
const types_1 = require("../../../types");
exports.rinkebyENSNameSchema = Object.assign(Object.assign({}, ens_1.ENSNameBaseSchema), { version: 1, deploymentBlock: 0, name: 'ENSName', description: 'Rinkeby Ethereum Name Service (EIP 137)', thumbnail: 'https://ens.domains/img/ens.svg', website: 'https://github.com/ethereum/EIPs/blob/master/EIPS/eip-137.md', formatter: (asset) => __awaiter(void 0, void 0, void 0, function* () {
        return {
